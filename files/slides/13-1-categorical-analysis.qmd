...
- **Hypotheses:**
    - $H_0: \ \pi_{\text{Young}} - \pi_{\text{Old}} \ge 0$
    - $H_1: \ \pi_{\text{Young}} - \pi_{\text{Old}} < 0$
...
- Twilight wants to test whether the type of material checked out is independent of visitor role, or if certain roles are more likely to favor particular genres. Assume $\alpha = 0.05$. 
